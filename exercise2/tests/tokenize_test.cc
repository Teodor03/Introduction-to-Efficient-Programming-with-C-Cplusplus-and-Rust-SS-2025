...
TEST(TokenizerTest, StructuralTokens) {
    ...
    check_token_type(tokens.at(0), jayson::token_type::OBJECT_BEGIN);
    check_token_type(tokens.at(1), jayson::token_type::OBJECT_END);
    check_token_type(tokens.at(2), jayson::token_type::ARRAY_BEGIN);
    check_token_type(tokens.at(3), jayson::token_type::ARRAY_END);
    check_token_type(tokens.at(4), jayson::token_type::COLON);
    check_token_type(tokens.at(5), jayson::token_type::COMMA);
}
...
TEST(TokenizerTest, StringTokens) {
    ...
    check_string_token(tokens.at(0), "");
    check_string_token(tokens.at(1), "hello");
    check_string_token(tokens.at(2), "special chars: //");
    check_string_token(tokens.at(3), "\\");
}

// Test integer tokens
TEST(TokenizerTest, IntegerTokens) {
    auto tokens = tokenize_all("0 42 -123 2147483647");
    ASSERT_EQ(tokens.size(), 4);

    check_integer_token(tokens.at(0), 0);
    check_integer_token(tokens.at(1), 42);
    check_integer_token(tokens.at(2), -123);
    check_integer_token(tokens.at(3), 2147483647);
}
...
TEST(TokenizerTest, FloatTokens) {
    ...
    check_float_token(tokens.at(0), 0.0);
    check_float_token(tokens.at(1), 3.14);
    check_float_token(tokens.at(2), -2.718);
    check_float_token(tokens.at(3), 1.234e5);
    check_float_token(tokens.at(4), 6.022e23);
}
...
TEST(TokenizerTest, BooleanTokens) {
    ...
    check_boolean_token(tokens.at(0), true);
    check_boolean_token(tokens.at(1), false);
}
...
TEST(TokenizerTest, NullToken) {
    ...
    EXPECT_EQ(tokens.at(0).get_type(), jayson::token_type::NONE);
}
...
TEST(TokenizerTest, CommentTokens) {
    ...
    check_comment_token(tokens.at(0), " This is a comment");
    check_comment_token(tokens.at(1), " Another comment");
}
...
TEST(TokenizerTest, MixedTokens) {
    ...
    // First few tokens
    check_token_type(tokens.at(0), jayson::token_type::OBJECT_BEGIN);
    check_string_token(tokens.at(1), "name");
    check_token_type(tokens.at(2), jayson::token_type::COLON);
    check_string_token(tokens.at(3), "John");
    check_token_type(tokens.at(4), jayson::token_type::COMMA);

    // Comment token
    check_comment_token(tokens.at(23), " This is a comment");
}
...
TEST(TokenizerTest, NumberEdgeCases) {
    ...
    check_integer_token(tokens.at(0), 0);
    check_integer_token(tokens.at(1), 0);
}
...
TEST(TokenizerTest, ComplexJSON) {
  ...
  "glossary": {
    ...
    check_token_type(tokens.at(0), jayson::token_type::OBJECT_BEGIN);
    check_string_token(tokens.at(1), "glossary");
...
TEST(TokenizerTest, TokenOriginal) {
    ...
    EXPECT_EQ(tokens.at(0).get_original(), "{");
    EXPECT_EQ(tokens.at(1).get_original(), "\"test\"");
    EXPECT_EQ(tokens.at(2).get_original(), ":");
    EXPECT_EQ(tokens.at(3).get_original(), "123");
    EXPECT_EQ(tokens.at(4).get_original(), "}");
}
...
TEST(TokenizerTest, WhitespaceComprehensive) {
    ...
    check_token_type(tokens.at(0), jayson::token_type::OBJECT_BEGIN);
    check_token_type(tokens.at(1), jayson::token_type::STRING); // "key1"
    check_token_type(tokens.at(2), jayson::token_type::COLON);
    check_token_type(tokens.at(3), jayson::token_type::INTEGER); // 42
    check_token_type(tokens.at(4), jayson::token_type::COMMA);
    check_token_type(tokens.at(5), jayson::token_type::STRING); // "key2"
    check_token_type(tokens.at(6), jayson::token_type::COLON);
    check_token_type(tokens.at(7), jayson::token_type::ARRAY_BEGIN);
    check_token_type(tokens.at(8), jayson::token_type::BOOLEAN); // true
    check_token_type(tokens.at(9), jayson::token_type::COMMA);
    check_token_type(tokens.at(10), jayson::token_type::BOOLEAN); // false
    check_token_type(tokens.at(11), jayson::token_type::COMMA);
    check_token_type(tokens.at(12), jayson::token_type::NONE); // null
    check_token_type(tokens.at(13), jayson::token_type::COMMA);
    check_token_type(tokens.at(14), jayson::token_type::FLOAT); // 3.14
    check_token_type(tokens.at(15), jayson::token_type::ARRAY_END);
    check_token_type(tokens.at(16), jayson::token_type::OBJECT_END);
}
...
TEST(TokenizerTest, ExcessiveWhitespace) {
    ...
    ASSERT_EQ(tokens.size(), 5);
    check_token_type(tokens.at(0), jayson::token_type::OBJECT_BEGIN);
    check_token_type(tokens.at(1), jayson::token_type::STRING);
    check_token_type(tokens.at(2), jayson::token_type::COLON);
    check_token_type(tokens.at(3), jayson::token_type::INTEGER);
    check_token_type(tokens.at(4), jayson::token_type::OBJECT_END);
}
...
TEST(TokenizerTest, NoWhitespace) {
    auto tokens =
        tokenize_all("{\"key\":42,\"array\":[true,false,null],\"nested\":{\"inner\":3.14}}");

    ASSERT_EQ(tokens.size(), 23);
    // Verify all tokens are correctly parsed despite lack of whitespace
    check_token_type(tokens.at(0), jayson::token_type::OBJECT_BEGIN);
    check_token_type(tokens.at(1), jayson::token_type::STRING); // "key"
    check_token_type(tokens.at(2), jayson::token_type::COLON);
    check_token_type(tokens.at(3), jayson::token_type::INTEGER); // 42
    check_token_type(tokens.at(4), jayson::token_type::COMMA);
    check_token_type(tokens.at(5), jayson::token_type::STRING); // "array"
    check_token_type(tokens.at(6), jayson::token_type::COLON);
    check_token_type(tokens.at(7), jayson::token_type::ARRAY_BEGIN);
    check_token_type(tokens.at(8), jayson::token_type::BOOLEAN); // true
    check_token_type(tokens.at(9), jayson::token_type::COMMA);
    ...
    check_token_type(tokens.at(11), jayson::token_type::COMMA);
    check_token_type(tokens.at(12), jayson::token_type::NONE); // null
    check_token_type(tokens.at(13), jayson::token_type::ARRAY_END);
    check_token_type(tokens.at(14), jayson::token_type::COMMA);
    check_token_type(tokens.at(15), jayson::token_type::STRING); // "nested"
    check_token_type(tokens.at(16), jayson::token_type::COLON);
    check_token_type(tokens.at(17), jayson::token_type::OBJECT_BEGIN);
    check_token_type(tokens.at(18), jayson::token_type::STRING);
    check_token_type(tokens.at(19), jayson::token_type::COLON);
    check_token_type(tokens.at(20), jayson::token_type::FLOAT);
    check_token_type(tokens.at(21), jayson::token_type::OBJECT_END);
    check_token_type(tokens.at(22), jayson::token_type::OBJECT_END);
}
...
TEST(TokenizerTest, WhitespaceWithComments) {
    ...
    check_token_type(tokens.at(0), jayson::token_type::OBJECT_BEGIN);
    check_token_type(tokens.at(1), jayson::token_type::COMMENT); // Comment after {
    check_token_type(tokens.at(2), jayson::token_type::STRING);  // "key"
    check_token_type(tokens.at(3), jayson::token_type::COLON);
    check_token_type(tokens.at(4), jayson::token_type::COMMENT); // Comment after :
    check_token_type(tokens.at(5), jayson::token_type::INTEGER); // 42
    check_token_type(tokens.at(6), jayson::token_type::COMMENT); // Comment after 42
    check_token_type(tokens.at(7), jayson::token_type::OBJECT_END);
    check_token_type(tokens.at(8), jayson::token_type::COMMENT);
}
...
TEST(TokenizerTest, ExponentNotations) {
    ...
    for (const auto &[input, expected] : exponents) {
        ...
        check_float_token(tokens.at(0), expected);
    }
}
...
TEST(TokenizerTest, IntegerFloatBoundary) {
    ...
    auto tokens = tokenize_all("123.0");
    ASSERT_EQ(tokens.size(), 1);
    EXPECT_EQ(tokens.at(0).get_type(), jayson::token_type::FLOAT);
}
